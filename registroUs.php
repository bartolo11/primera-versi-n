  ...
  <div class="main">
    ...
    <div class="view">
      ...
      <div class="container-fluid row">
        ...
        <form  class=" col-10 p-3 formulario" method="POST" onsubmit="return validarContrasena();" >
          <h3>Registro de Usuarios</h3>
          <hr    color="#000000";>

          <?php
          include "modelo/conexion.php";
          include "controlador/registroA.php";
          ?>
          ...
          <div class="mb-3">
            <label for="exampleInputEmail1" class="input_textual">Genero</label>
          ...
          <div class="mb-3">
            <label for="contraseña" class="input_textual">Contraseña</label>
          ...
          <div class="mb-3">
            <label for="exampleInputEmail1" class="input_textual">Tipo Usuario</label>
            <!--Genera el espacio para introducir la Cedula del administrador y envía 
              el dato cedula por medio del method post del formulario -->
