<?php 
  ...
  include "controlador/eliminarE.php";
            ...
            <tr>
              ...
              <td>
                <!--Se crea un enlace por medio del cual se llama la función modificacionA.php
                  ...
                  -->
                <a href="modificacionE.php?id=<?= $datos->idEstudiante ?>" class="btn btn-small btn-warning">
                ...
                <!--Se crea un enlace por medio del cual se llama a sí misma 
                  ...
                  -->
                <a onclick="return eliminar()" href="gestionEs.php?id=<?= $datos->idEstudiante ?>"  class="btn btn-small btn-danger" >
